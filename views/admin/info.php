            ...
            <div class="graf">
                ...
                <svg class="graph">
                    ...
                    <g class="grid y-grid" id="yGrid">
                        <line x1="26" x2="637" y1="10" y2="10"></line>
                        <line x1="26" x2="637" y1="68" y2="68"></line>
                        <line x1="26" x2="637" y1="126" y2="126"></line>
                        <line x1="26" x2="637" y1="185" y2="185"></line>
                        <line x1="26" x2="637" y1="243" y2="243"></line>
                        <line x1="26" x2="637" y1="301" y2="301"></line>
                        <line x1="26" x2="637" y1="360" y2="360"></line>
                    </g>
                    ...
                    <g class="labels y-labels">
                        <text x="20" y="15"><?=$max ?></text>
                        <text x="20" y="131"><?=round($max*0.666) ?></text>
                        <text x="20" y="248"><?=round($max*0.333) ?></text>
                        <text x="20" y="365">0</text>
                    </g>
                </svg>
            </div>
        </div>
