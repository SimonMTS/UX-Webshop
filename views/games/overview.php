<div class="container portrait">
	<div class="row">
		<div class="col-md-3 col-xs-8 search-games">
			<form method="POST">
		...
		<div class="col-md-7 col-xs-4 btn-games">
			...
			<div class="col-md-4 col-sm-12 center-games">
				<div class="overview-item" style="background-image: url(<?=$GLOBALS['config']['base_url'].$game['cover'] ?>);">
					<?php if ( isset($_SESSION['user']['role']) && $_SESSION['user']['role'] == 777 ) : ?>
							<a href="<?= $GLOBALS['config']['base_url'] ?>games/edit/<?=$game['id'] ?>" class="btn edit-btn">edit</a>
